...
export type ChatInput<C extends CommandPayload> = {
	chatInput(interaction: ChatInputCommandInteraction<"cached">, args: ArgumentsOf<C>): Promise<void> | void;
};

export type Autocomplete<C extends CommandPayload> = {
	autocomplete(interaction: AutocompleteInteraction<"cached">, args: ArgumentsOf<C>): Promise<void> | void;
};
...
export type UserContext<C extends CommandPayload> = {
	userContext(interaction: UserContextMenuCommandInteraction<"cached">, args: ArgumentsOf<C>): Promise<void> | void;
};
...
type CommandMethodParameters<C extends CommandPayload, M extends CommandMethod = CommandMethod.ChatInput> = Parameters<
	Commands<C>[M]
>;
